      ...
      <div className="pt-20">
        ...
        <section className="container mx-auto px-4 py-20 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            ...
            Получите экспертные советы, интерактивные 3D модели и круглосуточную
            помощь.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              ...
              size="lg"
              className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-blue-700 text-white px-8 py-4 text-lg font-medium transition-all duration-300 hover:from-blue-700 hover:to-blue-800 hover:shadow-lg transform hover:-translate-y-1 group shadow-xl"
            >
              Начать работу
            ...
            <Button
              variant="outline"
              size="lg"
              className="relative group bg-gradient-to-r from-orange-400 via-pink-500 to-rose-500 hover:from-orange-500 hover:via-pink-600 hover:to-rose-600 text-white hover:text-white px-8 py-4 text-lg font-bold transition-all duration-500 hover:shadow-2xl hover:shadow-rose-500/50 transform hover:-translate-y-1 rounded-2xl border border-pink-200/40 shadow-xl overflow-hidden"
              style={{ textShadow: "0 2px 10px rgba(0, 0, 0, 0.7)" }}
            >
              <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent rounded-2xl pointer-events-none group-hover:bg-transparent" />
          ...
          <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-12 max-w-4xl mx-auto shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                onClick={handleGetStarted}
                size="lg"
                className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-blue-700 text-white px-8 py-3 font-medium transition-all duration-300 hover:from-blue-700 hover:to-blue-800 hover:shadow-lg transform hover:-translate-y-1 group shadow-xl"
              >
