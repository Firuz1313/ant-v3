          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              ...
              <Button
                variant="outline"
                size="lg"
                className="relative group bg-gradient-to-r from-orange-400 via-pink-500 to-rose-500 hover:from-orange-500 hover:via-pink-600 hover:to-rose-600 text-white hover:text-white px-10 py-6 text-xl font-bold transition-all duration-500 hover:shadow-2xl hover:shadow-rose-500/50 transform hover:-translate-y-2 rounded-2xl border border-pink-200/40 shadow-xl overflow-hidden"
