...
export default function TVScreen({ panelBtnFromRemote, highlight, width = 900, height = 480, deviceId }: { panelBtnFromRemote?: number | null, highlight?: any, width?: number, height?: number, deviceId?: string }) {
